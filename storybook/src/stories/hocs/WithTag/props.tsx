...
export const storytitle = 'hocs/WithTag';
...
export const argTypes = {
  ...
  /* type: {
    ...
    table: {
      category: categories.OPTIONAL,
      defaultValue: {
        summary: INPUT_TYPE.TEXT,
      },
    },
  }, */
  // value: {
  //   description: 'Input value',
  //   control: { type: controlType.TEXT /* disable: true */ },
  //   table: {
  //     category: categories.OPTIONAL,
  //     defaultValue: {
  //       summary: String(void 0),
  ...
  /* id: {
    ...
    table: {
      category: categories.OPTIONAL,
      defaultValue: {
        summary: `InputWidget-${AbstractRoles.input}`,
      },
    },
  }, */
  /* style: {
