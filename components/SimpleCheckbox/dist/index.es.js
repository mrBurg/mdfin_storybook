...
function SimpleCheckbox(props) {
    ...
    useEffect(function () {
        setInputId(id || "checkbox_".concat(getSuffix()));
    }, [id]);
    useEffect(function () {
        setStyleClass(classNames('simple-checkbox', scss.checkbox, className));
    }, [className]);
    return (React.createElement("div", { className: styleClass },
        React.createElement("input", __assign({}, restProps, { type: WidgetRoles.checkbox, name: name, role: WidgetRoles.checkbox, checked: isChecked, id: inputId, onChange: function (event) { return changeHandler(event.target); } })),
        renderLabel()));
}
