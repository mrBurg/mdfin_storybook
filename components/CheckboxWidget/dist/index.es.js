...
function CheckboxWidget(props) {
    ...
    useEffect(function () {
        setStyleClass(classNames('checkbox-widget', scss.CheckboxWidget, className));
    }, [className]);
    return (React.createElement("div", { className: styleClass },
        React.createElement(SimpleCheckbox, __assign({}, restProps))));
}
