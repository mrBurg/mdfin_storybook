...
export declare class FaceTecFaceScanResultCallback {
  proceedToNextStep: (
    ...
    idScanNextStep?: FaceTecIDScanNextStep
  ) => void;
...
export declare abstract class FaceTecFaceScanProcessor {
  ...
  abstract processSessionResultWhileFaceTecSDKWaits: (
...
export declare abstract class FaceTecIDScanProcessor {
  ...
  abstract processIDScanResultWhileFaceTecSDKWaits: (
    idScanResult: FaceTecIDScanResult,
    idCheckResultCallback: FaceTecIDScanResultCallback
  ) => void;
}
/**
