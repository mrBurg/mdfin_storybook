import {
  ...
  FaceTecFeedbackBarCustomization,
  FaceTecFrameCustomization,
  FaceTecExitAnimationCustomization,
  ...
  FaceTecEnterFullScreenCustomization,
...
export declare var FaceTecSDK: {
  ...
  initializeInDevelopmentMode: (
    ...
    onInitializationComplete: InitializeCallback
  ) => void;
  /**
   ...
   **/
  getFriendlyDescriptionForFaceTecSDKStatus: (
    enumValue: FaceTecSDKStatus
  ) => string;
  /**
   ...
   **/
  getFriendlyDescriptionForFaceTecIDScanStatus: (
    enumValue: FaceTecIDScanStatus
  ) => string;
  /**
  ...
  getFriendlyDescriptionForFaceTecSessionStatus: (
    enumValue: FaceTecSessionStatus
  ) => string;
  /**
   ...
   */
  configureLocalization: (localizationJSON: { [key: string]: string }) => void;
  /**
  ...
  setMaxAuditTrailImages: (
    auditTrailImagesToReturn: FaceTecAuditTrailImagesToReturn
  ) => void;
  /**
