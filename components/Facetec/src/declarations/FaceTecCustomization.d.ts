...
export declare class FaceTecCustomization {
  ...
  [key: string]:
    ...
    | boolean
    | FaceTecVocalGuidanceCustomization
...
export declare class FaceTecSecurityWatermarkCustomization {
  securityWatermarkImage: FaceTecSecurityWatermarkImage;
  constructor();
  setSecurityWatermarkImage(
    selectedSecurityWatermarkImage: FaceTecSecurityWatermarkImage
  ): void;
  [key: string]:
...
export declare var FaceTecCustomizations: {
  ...
  setLowLightCustomization: (
    llCustomization: FaceTecCustomization | null
  ) => void;
  setDynamicDimmingCustomization: (
    ddCustomization: FaceTecCustomization | null
  ) => void;
  ...
  verifyColorCustomizations: (
    latestCustomization: FaceTecCustomization
  ) => void;
