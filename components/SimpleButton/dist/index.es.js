...
function SimpleButton(props) {
    var _a = props.role, role = _a === void 0 ? WidgetRoles.button : _a, _b = props.type, type = _b === void 0 ? BUTTON_TYPE.SUBMIT : _b, children = props.children, className = props.className, restProps = __rest(props, ["role", "type", "children", "className"]);
    var _c = useState(null), styleClass = _c[0], setStyleClass = _c[1];
    useEffect(function () {
        setStyleClass(classNames('simple-button', scss.simpleButton, scss[type], className));
    }, [className]);
    return (React.createElement("button", __assign({}, restProps, { className: styleClass, type: type, role: role }), children));
}

export { BUTTON_TYPE, SimpleButton };
